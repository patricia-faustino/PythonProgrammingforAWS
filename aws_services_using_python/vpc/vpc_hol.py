"""
This script manages Amazon VPC instances using the Boto3 Python SDK
"""
...
print(f"Route Table with ID '{ig_id}' has been created.")
...
print(f"subnet_1 ID '{subnet_1['Subnet']['SubnetId']}', subnet_2 ID '{subnet_2['Subnet']['SubnetId']}',"
      f" subnet_3 ID '{subnet_3['Subnet']['SubnetId']}' has been created.")
